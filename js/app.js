(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-bedrooms")) new swiper_core_Swiper(".slider-bedrooms", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-living-room")) new swiper_core_Swiper(".slider-living-room", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            loop: true,
            pagination: {
                el: ".slider-living-room-pagination",
                clickable: true
            },
            breakpoints: {
                360: {
        ...
        if (document.querySelector(".slider-dining")) new swiper_core_Swiper(".slider-dining", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-kitchens")) new swiper_core_Swiper(".slider-kitchens", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-pool")) new swiper_core_Swiper(".slider-pool", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-yoga")) new swiper_core_Swiper(".slider-yoga", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        muteButton.innerHTML = '<img src="img/icons/sound-off.svg" alt="Mute">';
        ...
        videoPlayer.addEventListener("play", (function() {
            ...
            if (!videoPlayer.muted) muteButton.innerHTML = '<img src="img/icons/sound-on.svg" alt="Sound-on">';
        }));
        videoPlayer.addEventListener("pause", (function() {
            playButton.style.display = "block";
            pauseButton.style.display = "none";
            if (videoPlayer.muted) muteButton.innerHTML = '<img src="img/icons/sound-off.svg" alt="Mute">';
        }));
        ...
        muteButton.addEventListener("click", (function() {
            if (videoPlayer.muted) {
                ...
                muteButton.innerHTML = '<img src="img/icons/sound-on.svg" alt="Sound-on">';
            } else {
                videoPlayer.muted = true;
                muteButton.innerHTML = '<img src="img/icons/sound-off.svg" alt="Mute">';
            }
        ...
        window.addEventListener("scroll", (function() {
            ...
            if (isVisible && videoPlayer.paused) videoPlayer.play(); else if (!isVisible && !videoPlayer.paused) videoPlayer.pause();
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const videoPlayer = document.getElementById("video-gallery-player");
        const playButton = document.getElementById("play-gallery");
        const pauseButton = document.getElementById("pause-gallery");
        const muteButton = document.getElementById("mute-gallery");
        playButton.style.display = "none";
        pauseButton.style.display = "block";
        muteButton.innerHTML = '<img src="img/icons/sound-off.svg" alt="Mute">';
        videoPlayer.muted = true;
        ...
        window.addEventListener("scroll", (function() {
            const videoRect = videoPlayer.getBoundingClientRect();
            const isVisible = videoRect.top <= window.innerHeight && videoRect.bottom >= 0;
            if (isVisible && videoPlayer.paused) {
                videoPlayer.play();
                videoPlayer.muted = true;
            } else if (!isVisible && !videoPlayer.paused) {
                videoPlayer.pause();
                videoPlayer.muted = true;
                muteButton.innerHTML = '<img src="img/icons/sound-off.svg" alt="Mute">';
            }
